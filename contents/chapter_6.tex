...
\begin{figure}[H]
  ...
  \bicaption{系统技术实现图}{System Implementation Diagram}
...
\begin{figure}[H]
  ...
  \bicaption{系统登陆页}{System Login Page}
  \label{fig:ch6-login}
\end{figure}
...
\begin{figure}[H]
  ...
  \bicaption{系统回答页}{System Response Page}
...
\begin{figure}[H]
  ...
  \bicaption{工具浏览页}{Tools Display Page}
...
\begin{figure}[H]
  ...
  \bicaption{工具知识图谱可视化}{Tool Knowledge Graph Visualization}
...
\begin{figure}[H]
  ...
  \bicaption{添加自定义API}{Add Tool Page}
